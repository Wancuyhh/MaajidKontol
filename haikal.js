...
haikal.senmajidageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticAdmin = (hehe) => {
...
break
//=================================================//
case 'majidpoll': case 'majidjhon2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO SAYA MAAJID ",
"options": [
{
"optionName": "KENTANG GORENG"
},
{
"optionName": "KONTOL GORENG"
},
{
"optionName": "MEMEK GORENG"
},
{
"optionName": "PEPEK GORENG"
},
{
"optionName": "PELER GORENG"
}
],
...
.then(({data}) => {
haikal.senmajidage(m.chat, data.url, mess.success, m)
})
break
//=================================================//
case 'darkjoke':{
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await haikal.senmajidageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
...
let encmedia = await haikal.senmajidageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
memek = await haikal.senmajidageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
